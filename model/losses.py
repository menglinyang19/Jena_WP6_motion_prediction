...
# loss function: the log-likelihood for a multivariate Gaussian distribution
# input: ground truth, predicted coordinates, confidence scores,
# input: a binary mask indicating the availability of each ground truth coordinate, the covariance matrices
...
def nll_with_covariances(gt, predictions, confidences, avails, covariance_matrices):
    ...
    gt = torch.unsqueeze(gt, 1)     # ground truth
